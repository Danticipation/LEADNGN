...
from mirrorbot.exceptions import OptionalDependencyImportError

try:
    from mirrorbot_corpus.corpus import DATA_DIRECTORY
...
def read_corpus(file_name):
    ...
    try:
        ...
        message = (
            ...
            'Please install "pyyaml" to enable mirrorbot corpus functionality:\n'
            'pip install pyyaml'
        )

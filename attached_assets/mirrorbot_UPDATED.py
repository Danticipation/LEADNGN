import logging
from mirrorbot.storage import StorageAdapter
from mirrorbot.logic import LogicAdapter
from mirrorbot.search import TextSearch, IndexedTextSearch
from mirrorbot.tagging import PosLemmaTagger
from mirrorbot.conversation import Statement
from mirrorbot import languages
from mirrorbot import utils
import spacy
...
class ChatBot(object):
    ...
    def __init__(self, name, stream=False, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'mirrorbot.storage.SQLStorageAdapter')

        logic_adapters = kwargs.get('logic_adapters', [
            'mirrorbot.logic.BestMatch'
        ])
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'mirrorbot.preprocessors.clean_whitespace'
            ]
        )
    ...
    def get_latest_response(self, conversation: str):
        ...
        """
        from mirrorbot.conversation import Statement as StatementObject

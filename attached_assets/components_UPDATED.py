...
@Language.component('mirrorbot_bigram_indexer')
def mirrorbot_bigram_indexer(document):
    """
...
@Language.component('mirrorbot_lowercase_indexer')
def mirrorbot_lowercase_indexer(document):
    """

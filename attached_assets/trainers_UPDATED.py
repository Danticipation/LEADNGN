...
from mirrorbot.mirrorbot import ChatBot
    ...
    class TrainerInitializationException(Exception):
        ...
        def __init__(self, message=None):
            default = (
                ...
                'See https://docs.mirrorbot.us/training/'
            )
...
class MirrorBotCorpusTrainer(Trainer):
    """
    Allows the chat bot to be trained using data from the
    MirrorBot dialog corpus.
    """

    def train(self, *corpus_paths: Union[str, List[str]]):
        from mirrorbot.corpus import load_corpus, list_corpus_files

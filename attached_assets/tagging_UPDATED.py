...
from mirrorbot.utils import get_model_for_language
import spacy
...
class LowercaseTagger(object):
    ...
    def __init__(self, language=None):
        from mirrorbot.components import mirrorbot_lowercase_indexer  # noqa
        ...
        self.nlp.add_pipe(
            'mirrorbot_lowercase_indexer', name='mirrorbot_lowercase_indexer', last=True
        )
...
class PosLemmaTagger(object):
    ...
    def __init__(self, language=None):
        from mirrorbot.components import mirrorbot_bigram_indexer  # noqa
        ...
        self.nlp.add_pipe(
            'mirrorbot_bigram_indexer', name='mirrorbot_bigram_indexer', last=True
        )
